...
PG = create_engine(
    "postgresql+psycopg2://itc6050:itc6050@localhost:5432/shop_lab"
)
...
db.orders_embedded.insert_many(
    embedded.to_dict(orient="records")
)

print(
    f"Loaded {db.orders.count_documents({})} reference-style orders"
)

print(
    f"Loaded {db.orders_embedded.count_documents({})} embedded-style orders"
)
